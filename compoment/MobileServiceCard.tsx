...
const MobileServiceCard = ({image, title, price, navigation}) => {
  return (
    ...
    <Text style={{fontSize: 10, fontWeight: 'bold', color: '#16247d',  marginTop: 5, borderWidth: 2, padding: 4, borderColor: '#16247d', borderRadius: 5, textAlignVertical: 'center' , alignItems:'center'}}>Order Now</Text>
    </TouchableOpacity>
